...
// func Test_InsertActor(t *testing.T) {
// 	newActor := &Actor{
// 		FirstName: "John",
// 		LastName:  "Doe",
...
// 	err := InsertActor(gormDB, newActor)
...
// func Test_SelectAllActors(t *testing.T) {
...
// 	actors, total, err := SelectAllActors(gormDB, pagination)
...
// func Test_SelectOneActor(t *testing.T) {
// 	expectedActor := &Actor{
// 		ActorID:    1,
// 		FirstName:  "John",
// 		LastName:   "Doe",
...
// 	actor, err := SelectOneActor(gormDB, int64(expectedActor.ActorID))
// 	assert.NoError(t, err)
...
// func Test_SelectOneActorFilms(t *testing.T) {
// 	fixedTime := time.Now()
...
// 	actor, err := SelectOneActorFilms(gormDB, int64(expectedActor.ActorID))
